              ...
              <th colspan="5">
                <span class="ordertitle"
                  ...
                  <span class="pull-right delete"
                    ><img src="../images/delete.png" alt="" /></span
                ></span>
              </th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="(sku, index) in order.orderDetailList" :key="index">
              <td>
                <div class="typographic">
                  <img :src="sku.imgUrl" style="width: 80px" alt="" />
                  <a class="block-text">{{ sku.skuName }}</a>
